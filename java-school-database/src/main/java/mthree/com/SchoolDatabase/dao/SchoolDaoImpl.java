    ...
    * Do not change any code outside of the placeholders provided.
    ...
    public List<Course> csCourses() {
        ...
        // YOUR CODE STARTS HERE
         ...
         String sql = "SELECT course.courseCode, course.courseDesc FROM course INNER JOIN teacher ON course.teacherId = teacher.tid WHERE teacher.dept = 'Computer Science';";
    ...
    public List<StudentClassCount> studentsPerClass() {
        ...
        String sql = "SELECT course.courseCode, course.courseDesc, COUNT(course_student.student_id) AS numStudents FROM course JOIN course_student ON course.cid = course_student.course_id GROUP BY course.courseCode";
    ...
    public void editCourseDescription() {
        ...
        String sql = "UPDATE course SET courseDesc = 'Advance Python with Flask' WHERE courseCode = 'CS305';";
